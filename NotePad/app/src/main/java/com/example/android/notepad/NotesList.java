...
//            case R.id.export:
//                Intent intent = getIntent();
//                AbstractCursor mCursor = null;
//                mCursor.moveToFirst();
//                int colTitleIndex = mCursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_TITLE);
//                String title = mCursor.getString(colTitleIndex);//查询到title
//                int colNoteIndex=mCursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_NOTE);
//                String note=mCursor.getString(colNoteIndex);//查询到note
//                String filePath="/NotePadExport/";//指定路径
//                String fileName=title+".txt";//指定文件名
//                writeTxtToFile("txt content", filePath, fileName);//创建文件
//               return true;
...
//    private void writeTxtToFile(String s, String filePath, String fileName) {
//        //生成文件夹之后，再生成文件，不然会出错
